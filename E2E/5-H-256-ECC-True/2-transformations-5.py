...
def image_splicing_attack(image_path, image, min_patch_size=0.2, max_patch_size=0.4, directory="CLIC-Immune"):
    """
...
if __name__ == "__main__":
    ...
    Datasets = ['tmp']  # "MetFace", "DIV2K", "CLIC-F", "DIV2K"
    for data in Datasets:
        for t in transformations:
            ...
            params = {
                ########## Authentic Transformations
                "jpeg_compression": {'min_q': 70, 'max_q': 95},
                "jpeg2000_compression": {"min_db": 40, 'max_db': 60},
                "resize_keep_ratio": {"min_scale": 0.5, 'max_scale':0.9},
                "add_gaussian_noise": {"mean": 0, "min_std": 0.01, 'max_std': 0.04},
                "apply_gaussian_blur": {"min_radius": 0.1, "max_radius":0.4},
