...
def analyze_csv(file_path, file_name, threshold):
    ...
    # counts = df['Verification Result'].value_counts()
    # percentages = counts / counts.sum() * 100
    # print(file_name, percentages)

    # Plot 1: Histogram of Verification Result (True/False)
    plt.figure(figsize=(10, 6))
    ax = sns.histplot(data=df, x='Verification Result', hue='Verification Result', multiple='stack',
...
Datasets = ['CLIC-F']  # "MetFace", "FFHQ1000"
threshold = 6
