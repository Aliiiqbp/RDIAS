...
def extract_watermark(image):
    ...
    return extracted_hash_str, wm_present
...
def verify_image(image_path):
    ...
    extracted_full_hash = ''.join(extracted_hash_parts)  # Combine the 100-bit hashes into 400 bits

    # Compute the 256-bit hash of the entire image
    computed_full_hash = compute_phash(cover_image, hash_size=20)
