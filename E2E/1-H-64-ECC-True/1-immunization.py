...
def embed_watermark(image_path, hash_value):
    ...
    watermarked_image, _, _ = tm.encode(cover_image=cover, string_secret=hash_value, MODE='binary')
...
def main(input_directory, output_directory, csv_output):
    ...
    for filename in os.listdir(input_directory):
        ...
        if filename.endswith('.jpeg') or filename.endswith('.jpg') or filename.endswith('.png'):
            ...
            # Step 1: Immunization
            phash = compute_phash(image_path=original_image_path, hash_size=8)
            ...
            watermarked_image_hash = compute_phash(image_path=watermarked_image_path, hash_size=8)
...
if __name__ == "__main__":
    # "CLIC"
    Datasets = ['Amin']  # "MetFace", "CLIC", "DIV2K"
