...
div2k_file = 'DIV2K_dataset_1.csv'  # Replace with your actual file path
clic_file = 'CLIC_dataset_1.csv'    # Replace with your actual file path

# Compute and save accuracy for each dataset
compute_accuracy_and_save(div2k_file, 'DIV2K_accuracy_1.csv')
compute_accuracy_and_save(clic_file, 'CLIC_accuracy_1.csv')
